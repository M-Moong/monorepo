...
export function Ch09Finale() {
  return (
    <ChapterSection chIndex={8} autoHeight>
      ...
      <div className="mb-2 text-3xs tracking-[0.4rem] text-gold">· 마음 전하실 곳 ·</div>
      ...
      <div className="mt-12 text-center text-3xs tracking-[0.5rem] text-fg/40">· FIN ·</div>
      <div className="mt-3.5 text-center font-serif text-[1.375rem] text-gold italic">
        {WEDDING.groom.initial} &amp; {WEDDING.bride.initial}
      </div>
      <div className="mt-1.5 pb-10 text-center text-3xs tracking-[0.3rem] text-fg/40">
