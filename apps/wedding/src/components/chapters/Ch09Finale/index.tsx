...
export function Ch09Finale() {
  return (
    <ChapterSection chIndex={8} autoHeight>
      ...
      <div className="mb-6 border-y border-fg/20 py-5 text-center">
      ...
      <div className="mb-2 text-2xs tracking-[0.4rem] text-gold">· 마음 전하실 곳 ·</div>
      <p className="mb-3.5 text-xs3 leading-[1.55] text-fg/55">
      ...
      <div className="mt-12 text-center text-2xs tracking-[0.5rem] text-fg/40">· FIN ·</div>
      <div className="mt-3.5 text-center font-serif text-[1.375rem] text-gold italic">
        {WEDDING.groom.initial} &amp; {WEDDING.bride.initial}
      </div>
      <div className="mt-1.5 pb-10 text-center text-2xs tracking-[0.3rem] text-fg/40">
